...
def _load_sessions_cli(monkeypatch):
    ...
    path = Path(__file__).resolve().parent.parent / "scripts" / "argodesk-sessions"
    loader = importlib.machinery.SourceFileLoader("argodesk_sessions_cli_under_test", str(path))
