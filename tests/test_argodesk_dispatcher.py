...
def _load_dispatcher():
    path = Path(__file__).resolve().parent.parent / "scripts" / "argodesk"
    loader = importlib.machinery.SourceFileLoader("argodesk_dispatcher_under_test", str(path))
