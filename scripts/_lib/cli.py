"""scripts/_lib/cli.py — shared scaffolding for the `argodesk-*` CLIs.
...
parents-parser pattern. Usage:
    ...
    def build_parser():
        p = common_parser("argodesk-foo", "Description.")
...
# Make repo root importable. Tools are invoked as `scripts/argodesk-foo`
...
VERSION = "0.1.0"  # bumped centrally; every argodesk-* CLI reports this
