...
class TaskScheduler:
    ...
    async def _deliver_via_email(self, output: str, task, result: str):
        ...
        try:
            ...
            msg["X-ArgoDesk-Origin"] = "argodesk-ui"
            msg["X-ArgoDesk-Kind"] = "task"
            msg["X-ArgoDesk-Ref"] = str(task.id)
    ...
    async def _deliver_via_mcp(self, tool_name: str, task, result: str):
        ...
        args = {
            ...
            "body": result,
            "headers": {
                "X-ArgoDesk-Origin": "argodesk-ui",
                "X-ArgoDesk-Kind": "task",
                "X-ArgoDesk-Ref": str(task.id),
            },
        }
        if recipient:
