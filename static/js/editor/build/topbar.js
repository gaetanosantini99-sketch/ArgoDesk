...
export function buildTopbar() {
  ...
  topBar.innerHTML = `
    <div class="ge-topbar-left">
      <span class="ge-alpha-badge" title="Questo editor è in sviluppo attivo — possibili imperfezioni">ALPHA</span>
      <button class="ge-btn ge-btn-sm ge-stacked-btn" id="ge-undo" title="Annulla">
      ...
      <button class="ge-btn ge-btn-sm ge-stacked-btn" id="ge-history-btn" title="Cronologia — clicca una voce per saltare a quello stato" aria-label="Cronologia">
      ...
      <button class="ge-btn ge-btn-sm" id="ge-zoom-out" title="Riduci">&minus;</button>
      ...
      <button class="ge-btn ge-btn-sm" id="ge-zoom-in" title="Ingrandisci">+</button>
      <span class="ge-topbar-sep"></span>
      <button class="ge-btn ge-btn-sm ge-stacked-btn" id="ge-zoom-fit" title="Adatta alla vista" aria-pressed="false">
    ...
    <div class="ge-topbar-right">
      ...
      <div class="ge-image-wrap">
        <button class="ge-btn ge-btn-sm" id="ge-image-menu-btn" title="Azioni immagine" aria-haspopup="true">Image ▾</button>
        <div class="ge-image-menu dropdown" id="ge-image-menu" hidden>
          <button class="dropdown-item-compact" data-image-action="resize">
            <span class="dropdown-icon">⤢</span>
            <span>Canvas…</span>
          </button>
          <div class="ge-filter-submenu-label">Trasforma</div>
      ...
      <button class="ge-btn ge-btn-sm" id="ge-import-topbar" title="Importa immagine come livello">+ Import</button>
      <div class="ge-save-wrap">
        <button class="ge-btn ge-btn-primary" id="ge-save-menu-btn" title="Opzioni di salvataggio" style="display:inline-flex;align-items:center;gap:4px;">Salva
        ...
        <div class="ge-save-menu dropdown" id="ge-save-menu" hidden>
          <div class="dropdown-section-label">Immagine</div>
          <button class="dropdown-item-compact" id="ge-save" title="Sovrascrivi l’immagine originale">
          ...
          <button class="dropdown-item-compact" id="ge-export-gallery" title="Salva come nuova immagine nella galleria">
          ...
          <button class="dropdown-item-compact" id="ge-download" title="Scarica PNG sul tuo computer">
          ...
          <button class="dropdown-item-compact" id="ge-load-project" title="Apri un file di progetto salvato in precedenza">
