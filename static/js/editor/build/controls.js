  ...
  return `
    ...
    <div class="ge-lasso-section" id="ge-lasso-section" style="display:none;">
      <div class="ge-control-row ge-eraser-row ge-sel-refine" id="ge-lasso-refine-feather" style="display:none;">
        ...
        <label>Sfuma <span id="ge-lasso-feather-label">0px</span></label>
      ...
      <div class="ge-control-row ge-eraser-row ge-sel-refine" id="ge-lasso-refine-grow" style="display:none;">
        ...
        <label>Tratto bordo <span id="ge-lasso-grow-label">0px</span></label>
      ...
      <div class="ge-control-row ge-actions" style="margin-top:4px;flex-wrap:wrap;">
        ...
        <button class="ge-btn ge-btn-sm ge-btn-iconlabel" id="ge-lasso-delete" title="Elimina i pixel selezionati dal livello">
    ...
    <div class="ge-wand-section" id="ge-wand-section" style="display:none;">
      <div class="ge-control-row" style="display:flex;gap:4px;margin-bottom:4px;" title="How the next click combines with the current selection. Shift / Alt held during a click override this for one click.">
        <button type="button" class="ge-btn ge-btn-sm ge-wand-mode-btn active" data-wand-mode="replace" title="Replace selection on each click">Nuovo</button>
      ...
      <div class="ge-control-row ge-eraser-row ge-sel-refine" id="ge-wand-refine-feather" style="display:none;">
        ...
        <label>Sfuma <span id="ge-wand-feather-label">0px</span></label>
      ...
      <div class="ge-control-row ge-eraser-row ge-sel-refine" id="ge-wand-refine-grow" style="display:none;">
        ...
        <label>Tratto bordo <span id="ge-wand-grow-label">0px</span></label>
        <input type="range" id="ge-wand-grow" min="-40" max="40" value="0" title="Expand (+) or contract (−) the selection before baking." />
      </div>
      <div class="ge-control-row ge-actions" style="margin-top:4px;flex-wrap:wrap;">
        <button class="ge-btn ge-btn-sm ge-mask-vis-btn visible" id="ge-wand-vis" title="Nascondi sovrapposizione selezione" aria-label="Toggle selection overlay">
        ...
        <button class="ge-btn ge-btn-sm ge-btn-iconlabel" id="ge-wand-delete" title="Elimina i pixel selezionati dal livello">
    ...
    <div class="ge-inpaint-section" id="ge-inpaint-section" style="display:none;">
      ...
      <div class="ge-control-row ge-actions ge-inpaint-mask-row" style="margin-top:4px;">
        <button class="ge-btn ge-btn-sm ge-btn-iconlabel ge-mask-vis-btn visible" id="ge-mask-vis" title="Nascondi maschera">
      ...
      <div class="ge-control-row ge-inpaint-model-row" style="margin-top:6px;">
        <label for="ge-ai-inpaint">Modello</label>
      ...
      <div class="ge-control-row ge-actions" style="margin-top:6px;display:flex;gap:6px;align-items:center;min-width:0;">
        ...
        <button class="ge-btn ge-btn-ai" id="ge-inpaint-remove" style="flex:1 1 0;display:inline-flex;align-items:center;justify-content:center;gap:6px;" title="Erase the masked content and fill with the surrounding background. Ignores your prompt.">
          <span class="ge-btn-ai-mark" aria-hidden="true">✦</span>
          <span id="ge-inpaint-remove-label">Rimuovi</span>
        </button>
      ...
      <div class="ge-section-title ge-section-title-with-help" id="ge-inpaint-postedge-title"><span>POSTPROCESS</span><span class="ge-section-help" tabindex="0" role="img" aria-label="Cosa fa" title="Live edge trimming for the last Inpaint Result layer. Edge feather softens the alpha boundary; Edge stroke expands (+) or contracts (−) the visible edge into the AI buffer that was generated around your brush.">?</span></div>
      ...
      <div class="ge-control-row ge-eraser-row" id="ge-inpaint-edgestroke-row" style="display:none;">
        ...
        <label>Tratto bordo <span id="ge-edgestroke-label">0px</span></label>
    ...
    <div class="ge-eraser-section" id="ge-clone-section" style="display:none;">
      ...
      <div class="ge-control-row ge-eraser-row">
        ...
        <label>Opacità <span id="ge-clone-opacity-label">100%</span></label>
      ...
      <div class="ge-control-row ge-eraser-row">
        ...
        <label>Flusso <span id="ge-clone-flow-label">100%</span></label>
      ...
      <div class="ge-control-row ge-eraser-row">
        ...
        <label>Morbidezza <span id="ge-clone-softness-label">100%</span></label>
    ...
    <div class="ge-eraser-section" id="ge-brush-section" style="display:none;">
      <div class="ge-section-title">Pennello</div>
      <div class="ge-control-row ge-eraser-row">
        <span class="ge-eraser-preview" id="ge-brush-preview-opacity" aria-hidden="true"></span>
        <label>Opacità <span id="ge-brush-opacity-label">100%</span></label>
      ...
      <div class="ge-control-row ge-eraser-row">
        ...
        <label>Flusso <span id="ge-brush-flow-label">100%</span></label>
      ...
      <div class="ge-control-row ge-eraser-row">
        ...
        <label>Morbidezza <span id="ge-brush-softness-label">100%</span></label>
    ...
    <div class="ge-eraser-section" id="ge-eraser-section" style="display:none;">
      <div class="ge-section-title">Gomma</div>
      <div class="ge-control-row ge-eraser-row">
        <span class="ge-eraser-preview" id="ge-eraser-preview-opacity" aria-hidden="true"></span>
        <label>Opacità <span id="ge-eraser-opacity-label">100%</span></label>
      ...
      <div class="ge-control-row ge-eraser-row">
        ...
        <label>Flusso <span id="ge-eraser-flow-label">100%</span></label>
      ...
      <div class="ge-control-row ge-eraser-row">
        ...
        <label>Morbidezza <span id="ge-eraser-softness-label">100%</span></label>
    ...
    <div class="ge-rembg-section" id="ge-rembg-section" style="display:none;">
      ...
      <hr class="ge-section-divider" />
      <div class="ge-section-title ge-section-title-with-help"><span>Edge cleanup</span><span class="ge-section-help" tabindex="0" role="img" aria-label="Cosa fa" title="Live-applied to the last Bg Removed layer. Feather softens the edge; Edge nudges it inward (−) or outward (+).">?</span></div>
      <div class="ge-control-row ge-eraser-row">
        <span class="ge-eraser-preview" id="ge-rembg-feather-preview" aria-hidden="true"></span>
        <label>Sfuma <span id="ge-rembg-feather-label">0px</span></label>
    ...
    <div class="ge-harmonize-section" id="ge-harmonize-section" style="display:none;">
      ...
      <div class="ge-control-row ge-actions" style="margin-top:4px;">
        <button class="ge-btn ge-btn-primary" id="ge-harmonize-run">Armonizza</button>
      </div>
    </div>
    <div class="ge-style-section" id="ge-style-section" style="display:none;">
      ...
      <div class="ge-control-row ge-tool-model-row">
        <label>Modello</label>
        <select class="ge-tool-model" data-ge-tool-model="style" title="Modello per il trasferimento di stile">
          <option value="">Auto</option>
        </select>
      </div>
      <div class="ge-control-row">
      ...
      <div class="ge-control-row">
        <label style="font-size:11px;opacity:0.6;">Intensità <span id="ge-style-strength-label">0.55</span></label>
...
export function layerPanelHTML() {
  return `<div class="ge-layers-header">
      ...
      <button class="ge-btn ge-btn-sm ge-icon-btn" id="ge-merge-down" title="Unisci sotto" aria-label="Unisci sotto">
      ...
      <button class="ge-btn ge-btn-sm ge-icon-btn" id="ge-merge-all" title="Unisci tutto" aria-label="Unisci tutto">
      ...
      <button class="ge-btn ge-btn-sm ge-icon-btn" id="ge-flatten" title="Flatten copy (keeps originals)" aria-label="Unisci copia">
      ...
      <button class="ge-btn ge-btn-sm" id="ge-add-layer" title="Aggiungi livello vuoto">+ Add</button>
