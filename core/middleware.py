...
INTERNAL_TOOL_TOKEN = os.environ.get("ARGODESK_INTERNAL_TOKEN") or secrets.token_hex(32)
INTERNAL_TOOL_HEADER = "X-ArgoDesk-Internal-Token"
...
def require_admin(request: Request):
    ...
    # (a) header-direct (caller set X-ArgoDesk-Internal-Token), or
